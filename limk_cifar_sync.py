...
# 模型文件路径
#log_dir = "/home/zhaorenming/tensorflow_distributed_guide/tflog/log_tmp/"
# if not os.path.exists("/root/limk/"):
#     os.mkdir("/root/limk/")
#     print("**************mkdir*********")

log_dir = "/home/limk/dist_tensorflow/my_log"
    ...
    with tf.device(tf.train.replica_device_setter(worker_device=worker_device,
        ...
        with tf.train.MonitoredTrainingSession(master=server.target,
            ...
            while not mon_sess.should_stop():
                ...
                _, mean_loss_val, step, summary_mean_loss_val = mon_sess.run(
                    [optimizer, mean_loss, global_step, summary_mean_loss],
                ...
                accuracy_val, summary_test_set_accuracy_val = mon_sess.run(
                    [test_set_accuracy, summary_test_set_accuracy],
                    feed_dict=p_feed_dict)
                train_accuracy_val, summary_training_set_accuracy_val = mon_sess.run(
                    [training_set_accuracy, summary_training_set_accuracy],
                ...
                print(
                    "mean loss = {}\ttrain accuracy = {:.2f}\tglobal accuracy = {:.2f}".format(
