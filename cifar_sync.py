...
# 模型文件路径
log_dir = "/mnt/sdc/zhaorenming/tensorflow_distributed_guide/tflog/log_tmp"
...
def main(unused_argv):
    ...
    server = tf.train.Server(
            cluster, job_name=FLAGS.job_name, task_index=FLAGS.task_index, config=gpu_config)
    ...
    #     定义优化器，指定要优化的损失函数
        ...
        with mts as sess:
            ...
            while not sess.should_stop():
                ...
                print('Worker %d: training local count %d done (global step:%d)' %
